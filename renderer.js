// ============================================
// ELECTRON WINDOW CONTROLS (handled via preload.js)
// ============================================
// Old remote API disabled for security.
// Use ipcRenderer exposed through preload.js instead.
// Example:
...
class PanelResizer {
  ...
  startDrag(e, panel) {
    // Simplified drag concept — can expand to full movement later
...
// ============================================
// SIMULATED REAL-TIME CAR DATA UPDATES
// ============================================
